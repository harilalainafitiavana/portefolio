        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
            ...
            <motion.header
                ...
                className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled
                    ...
                    : 'bg-gray-950/80 backdrop-blur-sm border-b border-white/10'
                    }`}
            >
                    ...
                    {isMenuOpen && (
                        <motion.div
                            ...
                            className={`md:hidden border-t overflow-hidden ${isScrolled
                                ...
                                : 'bg-gray-950/95 backdrop-blur-sm border-white/10'
                                }`}
                        >
                        ...
                        <div className="w-full lg:w-1/2 text-center lg:text-left order-2 lg:order-1">
                            ...
                            >
                                ...
                                <p className="text-base sm:text-lg md:text-xl text-gray-200 mb-6 sm:mb-8 leading-relaxed">
                                    ...
                                    Je développe des projets web pensés pour la qualité, la fluidité et l’expérience utilisateur.
                                </p>
                            </motion.div>
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                <div className="bg-white p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-lg">
                                    ...
                                    <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                                        Développeur Full Stack passionné par la création de solutions web modernes et performantes. Je développe une solide base technique et une forte capacité d’apprentissage continu.
                                    </p>
